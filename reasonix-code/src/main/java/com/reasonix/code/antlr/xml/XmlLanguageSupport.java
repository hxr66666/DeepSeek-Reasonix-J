package com.reasonix.code.antlr.xml;
...
public class XmlLanguageSupport implements AntlrLanguageSupport {

    private static final Set<String> EXTENSIONS = Set.of(".xml", ".xsd", ".xsl", ".xslt", ".svg");
    private static final Set<String> CLASS_RULES = Set.of("element");
    ...
    static {
        AntlrLanguageSupport.register(new XmlLanguageSupport());
    }
